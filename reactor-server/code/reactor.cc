...
Reactor::Reactor() { m_reactor_impl = new ReactorImplementation(); }

Reactor::~Reactor() { delete m_reactor_impl; }
...
void Reactor::HandleEvents() { m_reactor_impl->HandleEvents(); }
...
ReactorImplementation::~ReactorImplementation() { delete m_demultiplexer; }
